...
class HostBookingDetailsPage extends StatelessWidget {
  const HostBookingDetailsPage({super.key});


  // void _openPad(String number) async {
    ...
    return Column(
      children: [
        ...
        CustomElevatedButton(
          ...
          elevation: 0,
          onPressed: () {
            Get.toNamed(AppRoutes.hostCheckInPage);
          },
          isoutLined: true,
          color: ConstColor.white,
          outLineColour: Colors.grey,
          borderWidth: 2,
          child: CustomText(title: ConstString.viewCheckIn, fontWeight: FontWeight.w400, textColor: Color(0xff626262), textSize: AppSize.width(value: 18)),
        ),
