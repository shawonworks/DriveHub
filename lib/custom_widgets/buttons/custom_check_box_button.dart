        ...
        child: Checkbox(
          ...
          side: WidgetStateBorderSide.resolveWith((states) {
            if (states.contains(WidgetState.selected)) {
              return BorderSide(color: isValue ? widget.color ?? Colors.teal : Colors.white70);
            } else {
              return BorderSide(color: Colors.grey);
            }
          }),
          value: isValue,
          checkColor: widget.color ?? Colors.white,
          fillColor: isValue ? WidgetStatePropertyAll(Colors.teal) : WidgetStatePropertyAll(Colors.white),
          shape: RoundedRectangleBorder(
            side: BorderSide(color: widget.color ?? Colors.teal),
